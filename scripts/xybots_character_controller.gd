...
const STRAFE_LEFT_TRIGGER_X := 0.08                                                         # Set the left strafe threshold at the visible side-edge contact line.
const STRAFE_RIGHT_TRIGGER_X := 0.92                                                        # Set the right strafe threshold at the visible side-edge contact line.
const STRAFE_LEFT_WALL_CONTACT_X := 0.08                                                    # Set the closest blocked-wall contact position on the viewer's left.
const STRAFE_RIGHT_WALL_CONTACT_X := 0.92                                                   # Set the closest blocked-wall contact position on the viewer's right.
...
func _position_player() -> void:                                                            # Declare this function.
	...
	var screen_x := lerpf(x_min, x_max, clampf(local_floor_position.x, 0.0, 1.0)) * VIEWPORT_SIZE.x # Store mutable runtime state for assets, rendering, movement, or debug output.
