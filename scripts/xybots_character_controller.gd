...
const STRAFE_LEFT_TRIGGER_X := 0.24                                                         # Set the left strafe threshold where crossing a side edge begins.
const STRAFE_RIGHT_TRIGGER_X := 0.76                                                        # Set the right strafe threshold where crossing a side edge begins.
